...
We verified that these axis and line labels appear in our revised submission, but as the labels also appear in our proof of the original submission we received from Manuscript Central, this is not completely reassuring.
