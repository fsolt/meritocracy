...
\begin{enumerate}
\item Both reviewers pointed out that the article's tone is not professional, and some of its claims are inflated. We agreed with this criticism, and we reframe the article in a more humble and respective way and build up our discussion based on the replication and extention of NJL's paper.   
