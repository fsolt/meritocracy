...
In contrast to a range of earlier studies that found that greater inequality tends to reinforce support for the status quo,  Newman, Johnston, and Lown (\citeyear{Newman2015}, hereafter NJL) argues that inequality in the United States  activates class conflict, leading poorer individuals in local contexts of higher inequality to reject meritocracy and become more class conscious. However, that article crucially misinterprets the interaction term in its model \citep[see, e.g.,][]{Brambor2006}, and when correctly interpreted the results provide no support for the author's conclusions, but instead suggest the opposite. In addition to this minterpretation, the articl presents other problems, prompting th full, independent replication opresented here utilizing more and better data along with improved specification.
