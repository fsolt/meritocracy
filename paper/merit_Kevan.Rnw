...
How belief in meritocracy, and in turn the country's dominant ideology, fares in the face of the stark economic inequality that has come to characterize life in the United States is therefore crucial to understanding not only support for redistributive policies but also the continuing legitimacy of the U.S. economic system as a whole. This question and others regarding the relationship between economic inequality and political attitudes and beliefs have attracted considerable scholarly attention of late. 

In contrast to a range of earlier studies that found that greater inequality tends to reinforce support for the status quo,  Newman, Johnston, and Lown (\citeyear{Newman2015}, hereafter NJL) argues that local contexts of inequality in the United States  activates class conflict and consciousness, leading poorer individuals to reject meritocracy. However, that article crucially misinterprets the interaction term in its model \citep[see, e.g.,][]{Brambor2006}, and when correctly interpreted the results provide no support for the author's conclusions, but instead suggest the opposite. In addition to this minterpretation, the article presents other problems, prompting the full, independent replication presented here utilizing more and better data along with improved specification.

This analysis finds no evidence for the argument that high levels of economic inequality work to activate an ``oppositional consciousness'' among lower-income individuals and so are ultimately self-correcting (NJL p. 329).
...
As noted above, NJL advocates the conflict theory which maintains that, for lower-income individuals, being confronted with high levels of inequality locally ``increases the salience of their disadvantaged position within a conspicuous local economic hierarchy'' (NJL, 327) promoting class consciousness and, in turn, increased demand for redistribution.
Higher-income individuals in high inequality contexts, on the other hand, are expected to avoid the potential guilt and shame of their more obviously privileged position while also protecting this position by becoming even more certain of the importance of individual effort to the distribution of economic rewards.


The relative power theory starts with the proposition that money is a political resource: it can be used to influence others.
This means that, where the rich are richer relative to the poor, they will also be more powerful relative to the poor \citep{Goodin1980}.
This theory suggests that the resulting power imbalance provides high-income people with more resources to spread their views in the public sphere while depriving poorer people of the resources to resist these efforts.
This gives poorer people ``a greater susceptibility to the internalization of the values, beliefs, or rules of the game of the powerful [...] as a means of escaping the subjective sense of powerlessness, if not its objective condition'' \citep[17]{Gaventa1980}.
