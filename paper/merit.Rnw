...
It is well understood, of course, that controlling for variables that are causally downstream from an independent variable ``messes up'' the estimates of that independent variable's effect on the dependent variable \citet[188]{Gelman2007}.
...
As in the other Pew surveys discussed, respondents' incomes are measured in the RLS on a nine-point scale ranging from less than \$10,000 to over \$150,000. 
