...
To test the hypotheses provided by these to contending theories requires data both on individuals' belief in meritocracy and on the economic characteristics of the contexts in which they live.  Individual-level data are drawn from the U.S. Religious Landscape Survey conducted by the Pew Forum on Religion and Public Life in 2007.
