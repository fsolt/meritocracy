...
In light of their evident lack of comparability, we conclude that pooling them in a single analysis cannot be justified.\footnote{In a footnote and the article's online appendix, NJL argues that mixing these different measures is not problematic on the basis that the 2005 and 2006 surveys alone, which use Measure 1, yield results for the variables of interest similar to those produced by the four surveys together (NJL, p.331).  
