...
For those who would prefer higher levels of redistribution, which of the two theories better describes political reality is crucial to understanding the effort that will be required to reverse the decades-long trend of rising income inequality in the United States.
If the NJL results were sound, and the conflict theory supported, advocates of greater redistribution could remain relatively quiescent, confident that by activating conflict, higher levels of inequality would more or less automatically deliver the votes needed for the policies they prefer.
