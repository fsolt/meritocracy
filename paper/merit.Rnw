...
We plot the conditional effect of $Inequality$ at each value of $Income$ in Figure~\ref{F:coef_t1m1}. \nocite{Solt2015b} 
Contrary to the interpretation offered in \citet[334]{Newman2015}, the coefficient for county income inequality fails to reach statistical significance at any observed level of respondent family income.
The article's own results provide no evidence for its conclusion that poorer people are more likely to reject, and richer people more likely to embrace, the meritocratic ideal where local income inequality is greater.
