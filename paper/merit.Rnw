...
<<include=FALSE>>=
library(knitr)
opts_chunk$set(concordance=TRUE, cache=FALSE, warning=FALSE, message=FALSE, echo=FALSE, results='hide')
@
...
<<label=m23_gini, fig.width=5.5, fig.height=5.5>>=
...
<<label=predprob, echo=F, results='hide', include=FALSE>>==
